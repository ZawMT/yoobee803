...
However, the data is too skewed to use 5 classes for prediction. The follow shows the evaluation comparison between 5-classes prediction results and binarised results.
